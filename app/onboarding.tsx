...
const SLIDES = [
  {
    ...
    title: "Welcome to\nWater Timeout",
    description:
      "Your personal hydration companion. Track your water intake and keep your virtual bottle full!",
  ...
  },
  {
    ...
    description:
      "Simply tap the cup icons to log your intake. Sips, quarters, halves, or full cups - we count it all.",
  ...
  },
  {
    ...
    description:
      "Set your hydration hours and notification frequency in settings. Never miss a sip!",
  ...
  },
  {
    ...
    title: "Stay Healthy",
    description:
      "Customize your daily goals and bottle type in settings. Lets get started on your hydration journey!",
