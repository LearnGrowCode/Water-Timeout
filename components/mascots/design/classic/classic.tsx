...
export const classic: MascotDefinition = {
  ...
  dialogues: {
    sad: ["I'm feeling a bit empty...", "A drop of water would be nice!", "Dry as a desert here!"],
    mild: ["Getting there!", "A little more water, please?", "I can feel the flow!"],
    okay: ["Feeling good!", "Hydration is key!", "Steady as she goes!"],
    happy: ["Perfectly hydrated!", "I'm overflowing with joy!", "Best day ever!"],
  },
};
